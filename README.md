# AJAX-Based--Recommender-of-movies-with-sentiment-analysis-using-machine-learning-models
...
The details of the movies(title, genre, runtime, rating, poster, etc) are fetched using an API by IMDB, https://www.themoviedb.org/documentation/api, and using the IMDB id of the movie in the API, I did web scraping to get the reviews given by the user in the IMDB site using `beautifulsoup4` and performed sentiment analysis on those reviews.
...
1. Install all the libraries mentioned in the [requirements.txt](https://github.com/amardeveloper/AJAX-based-recommendations-on-movies-and-sentiment-analysis/blob/master/requirements.txt) file.
